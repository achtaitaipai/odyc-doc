;(() => {
	...
	function Os(n) {
		if (n.fragment !== null) {
			...
			let e = n.dirty
			;(n.dirty = [-1]), n.fragment && n.fragment.p(n.ctx, e), n.after_update.forEach(ht)
		}
	}
	function js(n) {
		let e = [],
	...
	function Fn(n) {
		...
		return {
			c() {
				;(e = C('div')), t && t.c(), g(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30')
			},
			m(s, r) {
	...
	function Ln(n) {
		...
		return {
			c() {
				;(e = C('div')), t && t.c(), g(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf')
			},
			m(s, r) {
				S(s, e, r), t && t.m(e, null)
			},
	...
	function Na(n) {
		...
		return {
			...
			d(R) {
				R && k(e), n[34](null), n[35](null), d && d.d(), T && T.d(), (_ = !1), G(c)
			}
		}
	}
